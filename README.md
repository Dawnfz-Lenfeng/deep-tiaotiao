...
- [TiaoYiTiao](#tiaoyitiao)
- [1.背景知识](#1背景知识)
  - [1.2 基础要素定义](#12-基础要素定义)
  - [1.3 DDPG算法](#13-ddpg算法)
- [2.“跳一跳”AI智能体](#2跳一跳ai智能体)
  - [2.1 智能体环境](#21-智能体环境)
  - [2.2 DDPG算法实现](#22-ddpg算法实现)
- [3.AI智能体效果](#3ai智能体效果)
- [4.总结](#4总结)


最近在学习一些关于强化学习的知识。当然，仅仅学习理论知识还是不够的，还是需要从实际案例上进行出发，利用强化学习搭建自己的AI智能体。
